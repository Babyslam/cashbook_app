import 'package:cashbook_nusantara/models/cash_flow.dart';
import 'package:cashbook_nusantara/models/menu.dart';
import 'package:cashbook_nusantara/services/db_helper.dart';
...
final List<Menu> _listMenu = [
  Menu(
    ...
    icon: 'lib/images/income.png',
    route: '/pemasukan',
  ),
  Menu(
    name: 'Tambah Pengeluaran',
    icon: 'lib/images/outcome.png',
    route: '/pengeluaran',
  ),
  Menu(
    name: 'Detail Cash Flow',
    icon: 'lib/images/detail.png',
    route: '/cashFlow',
  ),
  Menu(
    name: 'Pengaturan',
